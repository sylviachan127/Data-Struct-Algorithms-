...
public class RegexAssignment{
    ...
    public static boolean testEmail(String email){
        return email.matches("[A-Za-z]([A-Za-z]|[0-9]|_|-|\\.)*@[A-Za-z]([A-Za-z]|[0-9]|_|-|\\.)*\\.(com|org|net)");
    }
    ...
    public static boolean testAddress(String address){
    	return address.matches("[0-9]{1,5} ([A-Za-z]|[0-9]| |\\.|\\-)*\\n[A-Z]([A-Za-z]| |\\.|\\-)*,? [A-Z]{2} [0-9]{5}(\\-[0-9]{4})?");
    }
    ...
    public static boolean testJavaExecutable(String java){
        return java.matches("(\\n| |\\\\|/|\\*|\\\")*public static void main\\(String\\[\\] [^0-9]([A-Za-z]|[0-9]|\\$|_)*\\)(\\n| |\\\\|/|\\*|\\\")*");
    }
}